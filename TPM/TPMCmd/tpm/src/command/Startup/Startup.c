...
)
{
    ...
    //
    #ifdef DEBUG_PRINT
    LOG_INFO("IN STARTUP locality: %d Startup: %08x ", locality, startup);
    #endif
...
#  endif
    ...
    #ifdef DEBUG_PRINT
    LOG_INFO("IN STARTUP STILL TIMERSTARTUP OK : %d", OK);
    #endif
    // Start dictionary attack subsystem
    OK = OK && DAStartup(startup);

    #ifdef DEBUG_PRINT
    LOG_INFO("IN STARTUP STILL DSSTARTUP OK : %d", OK);
    #endif
    // Enable hierarchies
    OK = OK && HierarchyStartup(startup);

    #ifdef DEBUG_PRINT
    LOG_INFO("IN STARTUP STILL HIERARCHY OK : %d", OK);
    #endif
    ...
    #ifdef DEBUG_PRINT
    LOG_INFO("IN STARTUP STILL PCRSTARTUP OK : %d", OK);
    #endif
    ...
    #ifdef DEBUG_PRINT
    LOG_INFO("IN STARTUP STILL COMMANDAUDITSTARTUP OK : %d", OK);
    #endif
...
#  endif
    ...
    #ifdef DEBUG_PRINT
    LOG_INFO("IN STARTUP STILL SESSION OK : %d", OK);
    #endif
    // Initialize object table
    OK = OK && ObjectStartup();

    #ifdef DEBUG_PRINT
    LOG_INFO("IN STARTUP STILL OBJECT OK : %d", OK);
    #endif
    ...
    // #ifdef DEBUG_PRINT
    // LOG_INFO("IN STARTUP STILL NVENTITY OK : %d", OK);
    // #endif
