...
#include "TPM/TPMCmd/tpm/include/private/prototypes/Attest_spt_fp.h"
...
)
{
    ...
    // Input Validation
    LOG_INFO("IV: SIGN = %d SEL = %d",!IsSigningObject(signObject),!CryptSelectSignScheme(signObject, &in->inScheme) );
