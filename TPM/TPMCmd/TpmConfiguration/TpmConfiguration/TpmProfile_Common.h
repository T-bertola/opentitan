...
//***********************************************
#define ALG_ECC                     ALG_NO
#define     ALG_ECDH                        (YES * ALG_ECC)
#define     ALG_ECDSA                       (YES * ALG_ECC)
#define     ALG_ECDAA                       (NO * ALG_ECC)
#define     ALG_SM2                         (NO * ALG_ECC)
#define     ALG_ECSCHNORR                   (NO * ALG_ECC)
#define     ALG_ECMQV                       (NO * ALG_ECC)
#define     ALG_KDF1_SP800_56A              (NO * ALG_ECC)
#define     ALG_EDDSA                       (NO  * ALG_ECC)
#define     ALG_EDDSA_PH                    (NO  * ALG_ECC)

#define     ECC_NIST_P192                   (NO * ALG_ECC)
#define     ECC_NIST_P224                   (NO * ALG_ECC)
#define     ECC_NIST_P256                   (NO * ALG_ECC)
#define     ECC_NIST_P384                   (NO * ALG_ECC)
